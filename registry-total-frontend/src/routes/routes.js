  ...
  const routes = useRoutes([
    {
      element: (
        <UseAuth.Auth
          element={<Layout />}
          roles={["admin", "factory", "warranty", "agency"]}
        />
      ),
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/factory/get-from-warranty",
          element: <FactoryGetFromWarranty />,
        },
        {
          path: "/factory/statistic-product",
          element: <FactoryStatisticProduct />,
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/agency/notify-error-product",
          element: <NotifyErrorProduct />,
        },
        { path: "/agency/recall-product", element: <RecallProduct /> },
        { path: "/agency/unsold-product", element: <UnsoldProduct /> },
        {
          path: "/agency/statistic-product",
          element: <AgencyStatisticProduct />,
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/warranty/statistic-product",
          element: <WarrantyStatisticProduct />,
        },
      ],
    },
    {
